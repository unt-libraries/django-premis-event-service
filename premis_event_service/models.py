...
class Event(models.Model):
    ...
    ordinal = models.IntegerField(
        editable=False,
        null=True,
        help_text='Read-only field used for paging and sorting.'
    )
    ...
    # Options for the django_readonly_field app.
    # Since Django Models can't have a non-PK
    # Auto field, we'll let the DB assign these
    # and tell Django to leave them be.
    class ReadonlyMeta:
        readonly = ['ordinal']
